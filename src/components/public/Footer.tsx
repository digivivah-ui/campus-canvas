      ...
      <div className="container-college py-16">
            ...
            <Link to="/" className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-display text-lg font-bold leading-tight">
                  Mahatma Gandhi College<br />Of Management
                </h3>
              </div>
            </Link>
            <p className="text-sm opacity-80 leading-relaxed">
              Empowering students with knowledge, skills, and values to become ethical leaders of tomorrow since 1995.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-sm opacity-80">info@mgcm.ac.in</span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-primary-foreground/20 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm opacity-70">
            © {new Date().getFullYear()} Mahatma Gandhi College Of Management, Ashta. All rights reserved.
          </p>
